...
// ✅ SỬA: Sử dụng TimezoneService thay vì tự xử lý timezone
const formatDate = (dateValue) => {
    return TimezoneService.formatDate(dateValue);
};
...
class RecruitmentService extends BaseService {
    ...
    async getRequestByNo(requestNo) {
        ...
        // ✅ TRẢ VỀ: Record đã merge
        const mergedRecord = {
            ...matchingRecords, // ✅ SỬA: Lấy record đầu tiên thay vì toàn bộ array
            fromDate: minFromDate,
            toDate: maxToDate,
            fromDateFormatted: this.formatDate(minFromDate),
            toDateFormatted: this.formatDate(maxToDate),
    ...
    // ✅ SỬA: Sử dụng TimezoneService thay vì tự xử lý timezone
    formatDate(timestamp) {
        return TimezoneService.formatDate(timestamp);
    }
    ...
    // ✅ SỬA: Sử dụng TimezoneService thay vì tự xử lý timezone
    formatLarkTime(timeValue) {
        return TimezoneService.formatTime(timeValue);
    }
